...
#plt.autoscale()
plt.savefig(f"{result_file_path}/plots/2020-02-05/consistent_mu_mse.pdf")
#plt.show()
...
#plt.ticklabel_format(axis='y', style='sci', scilimits=(0, 0), fontsize=16)
#plt.autoscale()
plt.savefig(f"{result_file_path}/plots/2020-02-05/consistent_m_mse.pdf")
#plt.show()
...
if estimate_alpha_beta:
    ...
    plt.savefig(f"{result_file_path}/plots/2020-02-05/consistent_alpha_mse.pdf")
    #plt.show()
    ...
    plt.savefig(f"{result_file_path}/plots/2020-02-05/consistent_beta_mse.pdf")
    #plt.show()
